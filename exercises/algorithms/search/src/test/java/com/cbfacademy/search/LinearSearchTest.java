...
@DisplayName(value = "Linear Search Exercise")
public class LinearSearchTest {
    ...
    public void search_ReturnsIndexOfTargetValue(int target) {
        int index = linearSearch.search(testArray, target);
    ...
    public void search_returnsMinusOneWhenArrayIsEmpty() {
        ...
        int result = linearSearch.search(emptyArray, 3);
    ...
    public void search_returnsMinusOneWhenTargetIsNotFound() {
        int result = linearSearch.search(testArray, testArray.length * 2);
